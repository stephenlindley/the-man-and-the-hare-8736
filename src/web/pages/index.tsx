    ...
    <div className="min-h-screen bg-[#0a0908] text-[#e8e4dc] overflow-hidden relative">
      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
          <div 
            className={`max-w-5xl mx-auto text-center transition-all duration-1500 ease-out ${
          ...
          >
            ...
            {/* Title */}
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight leading-[0.9] mb-4" style={{ fontFamily: "'Cinzel', serif" }}>
              <span className="block text-[#c9a959]">The Man</span>
              <span className="block text-[#e8e4dc]/90 text-3xl sm:text-4xl md:text-5xl my-2 tracking-widest">&</span>
              <span className="block text-[#c9a959]">the Hare</span>
            </h1>
