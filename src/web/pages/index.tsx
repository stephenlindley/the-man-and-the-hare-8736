      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 relative">
          ...
          >
            ...
            {/* Title */}
            <h1 className="font-serif leading-[0.85] mb-4" style={{ fontFamily: "'Cinzel', serif" }}>
              <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] tracking-[-0.02em] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#d4af37] via-[#c9a959] to-[#8b6914] drop-shadow-[0_0_60px_rgba(201,169,89,0.3)]">
                THE MAN
              </span>
              <span className="block text-[#e8e4dc]/70 text-2xl sm:text-3xl md:text-4xl my-3 tracking-[0.5em] font-light">&</span>
              <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] tracking-[-0.02em] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#d4af37] via-[#c9a959] to-[#8b6914] drop-shadow-[0_0_60px_rgba(201,169,89,0.3)]">
                THE HARE
              </span>
            </h1>
